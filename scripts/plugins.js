...
export default class plugins {
  ...
  static handleExhaustion(actor, data) {
    ...
    if (!oneDndExhaustionEnabled) return actorExhaustionEffect?.delete();
    if (exhaustionLevel > 0 && !actorExhaustionEffect) {
      oneDndExhaustionEffectData.name = game.i18n.localize("REST-RECOVERY.OneDnDExhaustionEffect.Name");
